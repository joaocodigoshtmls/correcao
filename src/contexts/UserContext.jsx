...
export const UserProvider = ({ children }) => {
  ...
  const updateProfilePicture = (newProfilePictureUrl) => {
    console.log('🔄 Context: Atualizando foto de perfil (header preview) para:', newProfilePictureUrl);
    // Atualiza apenas a foto para exibição imediata (header), sem mexer no profile_picture persistido
    setUsuario(prev => {
      const updatedUser = {
        ...prev,
